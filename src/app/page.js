...
import { Tabs, Select, Footer } from "flowbite-react";
...
export default function Home() {
  ...
  return (
    <div>
      <div className="max-w-2xl py-20 mx-auto sm:py-24 lg:py-28">
        <div className="text-center">
          ...
          <div className="flex flex-col items-center justify-center mt-10 gap-x-6">
            <Tabs.Group style="default" className="justify-center w-full">
                ...
                <div className="rounded">
                  ...
                  >
                    ...
                    <textarea
                      ...
                      } w-full text-gray-900 bg-gray-50 rounded-b-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-base`}
                      placeholder="masukkan teksmu..."
                      value={value}
                      onInput={handleCountWords}
                    ></textarea>
                    <p className="block w-full text-right text-slate-700 dark:text-slate-300">
                      {wordCount}/20000
                    </p>
                  </div>
      ...
      <Footer container={true} className="w-full">
        <div className="w-full text-center">
          <Footer.Divider />
          <div className="w-full sm:flex sm:items-center sm:justify-between">
            <Footer.Copyright
              href="https://rogasper.netlify.com"
              by="Rogasper"
              year={2023}
            />
            <div className="flex mt-4 space-x-6 sm:mt-0 sm:justify-center">
              <Footer.Icon
                href="https://github.com/rogasper"
                icon={Icons.Github}
              />
              <Footer.Icon
                href="https://instagram.com/rogasper"
                icon={Icons.Instagram}
              />
              <Footer.Icon
                href="https://linkedin.com/in/rogasper"
                icon={Icons.Linkedin}
              />
            </div>
          </div>
